  ...
  render() {
    ...
    return (
      <View style={container}>
        <ChartGraphList displayByDays={coinData} style={styles.graphStyle} />
        <Container>
          <Content>
            <List>
              ...
              <ListItem>
                <Left>
                  <Text>Current USD price</Text>
                </Left>
                <Right>
                  <Text>${coinData.price_usd}</Text>
                </Right>
              </ListItem>
              <ListItem
                style={{
              ...
              <ListItem>
                ...
                <Right>
                  <Text style={{ marginLeft: 5 }}>{coinData.name}</Text>
              ...
              <ListItem>
                <Left>
                  <Text>Changes in last 7 days</Text>
                </Left>
                <Right>
                  <Text
                    style={
